...
print(f"O texto contém {a} letras [a]")
e = texto.lower().count("e")
print(f"O texto contém {e} letras [e]")
i = texto.lower().count("i")
print(f"O texto contém {i} letras [i]")
o = texto.lower().count("o")
print(f"O texto contém {o} letras [o]")
u = texto.lower().count("u")
print(f"O texto contém {u} letras [u]")